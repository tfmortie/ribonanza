...
#
python train.py -m conv -d train_data_DMS_1.csv -out model_dms_1_2310_457 -v 2 -embs 128 -nl 10 -bs 256 -lr 0.0003 -dev 1 -ne 20
python train.py -m conv -d train_data_2A3_1.csv -out model_2A3_1_2310_457 -v 2 -embs 128 -nl 10 -bs 256 -lr 0.0003 -dev 1 -ne 20